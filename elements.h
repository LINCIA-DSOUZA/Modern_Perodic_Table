...
extern void table() 
{
    ...
    strcpy(atom[25].electronic_configuration,"");
    strcpy(atom[25].history,"");
    atom[25].melting_point = 0.00000;
    atom[25].boiling_point = 0.00000;
    atom[25].ionic_radius = 0.00000;
    atom[25].isotopes = 0;
    atom[25].electronegativity = 0.00000;
    strcpy(atom[25].color,"");
    atom[25].group = 1;
    atom[25].period = 1;
    strcpy(atom[25].conductivity,"");
    strcpy(atom[25].luster,"");
    strcpy(atom[25].phase,"");
    atom[25].density = 0.00000;
    strcpy(atom[25].uses,"");
    ...
    strcpy(atom[26].electronic_configuration,"");
    strcpy(atom[26].history,"");
    atom[26].melting_point = 0.00000;
    atom[26].boiling_point = 0.00000;
    atom[26].ionic_radius = 0.00000;
    atom[26].isotopes = 0;
    atom[26].electronegativity = 0.00000;
    strcpy(atom[26].color,"");
    atom[26].group = 1;
    atom[26].period = 1;
    strcpy(atom[26].conductivity,"");
    strcpy(atom[26].luster,"");
    strcpy(atom[26].phase,"");
    atom[26].density = 0.00000;
    strcpy(atom[26].uses,"");
    ...
    strcpy(atom[27].electronic_configuration,"");
    strcpy(atom[27].history,"");
    atom[27].melting_point = 0.00000;
    atom[27].boiling_point = 0.00000;
    atom[27].ionic_radius = 0.00000;
    atom[27].isotopes = 0;
    atom[27].electronegativity = 0.00000;
    strcpy(atom[27].color,"");
    atom[27].group = 1;
    atom[27].period = 1;
    strcpy(atom[27].conductivity,"");
    strcpy(atom[27].luster,"");
    strcpy(atom[27].phase,"");
    atom[27].density = 0.00000;
    strcpy(atom[27].uses,"");
    ...
    strcpy(atom[28].electronic_configuration,"");
    strcpy(atom[28].history,"");
    atom[28].melting_point = 0.00000;
    atom[28].boiling_point = 0.00000;
    atom[28].ionic_radius = 0.00000;
    atom[28].isotopes = 0;
    atom[28].electronegativity = 0.00000;
    strcpy(atom[28].color,"");
    atom[28].group = 1;
    atom[28].period = 1;
    strcpy(atom[28].conductivity,"");
    strcpy(atom[28].luster,"");
    strcpy(atom[28].phase,"");
    atom[28].density = 0.00000;
    strcpy(atom[28].uses,"");
    ...
    strcpy(atom[29].electronic_configuration,"");
    strcpy(atom[29].history,"");
    atom[29].melting_point = 0.00000;
    atom[29].boiling_point = 0.00000;
    atom[29].ionic_radius = 0.00000;
    atom[29].isotopes = 0;
    atom[29].electronegativity = 0.00000;
    strcpy(atom[29].color,"");
    atom[29].group = 1;
    atom[29].period = 1;
    strcpy(atom[29].conductivity,"");
    strcpy(atom[29].luster,"");
    strcpy(atom[29].phase,"");
    atom[29].density = 0.00000;
    strcpy(atom[29].uses,"");
    ...
    strcpy(atom[30].electronic_configuration,"");
    strcpy(atom[30].history,"");
    atom[30].melting_point = 0.00000;
    atom[30].boiling_point = 0.00000;
    atom[30].ionic_radius = 0.00000;
    atom[30].isotopes = 0;
    atom[30].electronegativity = 0.00000;
    strcpy(atom[30].color,"");
    atom[30].group = 1;
    atom[30].period = 1;
    strcpy(atom[30].conductivity,"");
    strcpy(atom[30].luster,"");
    strcpy(atom[30].phase,"");
    atom[30].density = 0.00000;
    strcpy(atom[30].uses,"");
    ...
    strcpy(atom[31].electronic_configuration,"");
    strcpy(atom[31].history,"");
    atom[31].melting_point = 0.00000;
    atom[31].boiling_point = 0.00000;
    atom[31].ionic_radius = 0.00000;
    atom[31].isotopes = 0;
    atom[31].electronegativity = 0.00000;
    strcpy(atom[31].color,"");
    atom[31].group = 1;
    atom[31].period = 1;
    strcpy(atom[31].conductivity,"");
    strcpy(atom[31].luster,"");
    strcpy(atom[31].phase,"");
    atom[31].density = 0.00000;
    strcpy(atom[31].uses,"");
    ...
    strcpy(atom[32].electronic_configuration,"");
    strcpy(atom[32].history,"");
    atom[32].melting_point = 0.00000;
    atom[32].boiling_point = 0.00000;
    atom[32].ionic_radius = 0.00000;
    atom[32].isotopes = 0;
    atom[32].electronegativity = 0.00000;
    strcpy(atom[32].color,"");
    atom[32].group = 1;
    atom[32].period = 1;
    strcpy(atom[32].conductivity,"");
    strcpy(atom[32].luster,"");
    strcpy(atom[32].phase,"");
    atom[32].density = 0.00000;
    strcpy(atom[32].uses,"");
    ...
    strcpy(atom[33].electronic_configuration,"");
    strcpy(atom[33].history,"");
    atom[33].melting_point = 0.00000;
    atom[33].boiling_point = 0.00000;
    atom[33].ionic_radius = 0.00000;
    atom[33].isotopes = 0;
    atom[33].electronegativity = 0.00000;
    strcpy(atom[33].color,"");
    atom[33].group = 1;
    atom[33].period = 1;
    strcpy(atom[33].conductivity,"");
    strcpy(atom[33].luster,"");
    strcpy(atom[33].phase,"");
    atom[33].density = 0.00000;
    strcpy(atom[33].uses,"");
    ...
    strcpy(atom[34].electronic_configuration,"");
    strcpy(atom[34].history,"");
    atom[34].melting_point = 0.00000;
    atom[34].boiling_point = 0.00000;
    atom[34].ionic_radius = 0.00000;
    atom[34].isotopes = 0;
    atom[34].electronegativity = 0.00000;
    strcpy(atom[34].color,"");
    atom[34].group = 1;
    atom[34].period = 1;
    strcpy(atom[34].conductivity,"");
    strcpy(atom[34].luster,"");
    strcpy(atom[34].phase,"");
    atom[34].density = 0.00000;
    strcpy(atom[34].uses,"");
    ...
    strcpy(atom[35].electronic_configuration,"");
    strcpy(atom[35].history,"");
    atom[35].melting_point = 0.00000;
    atom[35].boiling_point = 0.00000;
    atom[35].ionic_radius = 0.00000;
    atom[35].isotopes = 0;
    atom[35].electronegativity = 0.00000;
    strcpy(atom[35].color,"");
    atom[35].group = 1;
    atom[35].period = 1;
    strcpy(atom[35].conductivity,"");
    strcpy(atom[35].luster,"");
    strcpy(atom[35].phase,"");
    atom[35].density = 0.00000;
    strcpy(atom[35].uses,"");
    ...
    strcpy(atom[36].electronic_configuration,"");
    strcpy(atom[36].history,"");
    atom[36].melting_point = 0.00000;
    atom[36].boiling_point = 0.00000;
    atom[36].ionic_radius = 0.00000;
    atom[36].isotopes = 0;
    atom[36].electronegativity = 0.00000;
    strcpy(atom[36].color,"");
    atom[36].group = 1;
    atom[36].period = 1;
    strcpy(atom[36].conductivity,"");
    strcpy(atom[36].luster,"");
    strcpy(atom[36].phase,"");
    atom[36].density = 0.00000;
    strcpy(atom[36].uses,"");
    ...
    strcpy(atom[37].electronic_configuration,"");
    strcpy(atom[37].history,"");
    atom[37].melting_point = 0.00000;
    atom[37].boiling_point = 0.00000;
    atom[37].ionic_radius = 0.00000;
    atom[37].isotopes = 0;
    atom[37].electronegativity = 0.00000;
    strcpy(atom[37].color,"");
    atom[37].group = 1;
    atom[37].period = 1;
    strcpy(atom[37].conductivity,"");
    strcpy(atom[37].luster,"");
    strcpy(atom[37].phase,"");
    atom[37].density = 0.00000;
    strcpy(atom[37].uses,"");
    ...
    strcpy(atom[38].electronic_configuration,"");
    strcpy(atom[38].history,"");
    atom[38].melting_point = 0.00000;
    atom[38].boiling_point = 0.00000;
    atom[38].ionic_radius = 0.00000;
    atom[38].isotopes = 0;
    atom[38].electronegativity = 0.00000;
    strcpy(atom[38].color,"");
    atom[38].group = 1;
    atom[38].period = 1;
    strcpy(atom[38].conductivity,"");
    strcpy(atom[38].luster,"");
    strcpy(atom[38].phase,"");
    atom[38].density = 0.00000;
    strcpy(atom[38].uses,"");
    ...
    strcpy(atom[39].electronic_configuration,"");
    strcpy(atom[39].history,"");
    atom[39].melting_point = 0.00000;
    atom[39].boiling_point = 0.00000;
    atom[39].ionic_radius = 0.00000;
    atom[39].isotopes = 0;
    atom[39].electronegativity = 0.00000;
    strcpy(atom[39].color,"");
    atom[39].group = 1;
    atom[39].period = 1;
    strcpy(atom[39].conductivity,"");
    strcpy(atom[39].luster,"");
    strcpy(atom[39].phase,"");
    atom[39].density = 0.00000;
    strcpy(atom[39].uses,"");
